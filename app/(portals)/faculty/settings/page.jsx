...
export default function FacultySettingsPage() {
  ...
  const [academicRank, setAcademicRank] = useState("Professor & HOD");
  ...
  useEffect(() => {
    if (profile) {
      ...
      const timer = setTimeout(() => {
        ...
        setDepartment(profile.stream || "Information Technology");
        setAcademicRank(profile.current_role || "Professor & HOD");
  ...
  const handleSave = async (e) => {
    ...
    const updates = {
      ...
      current_role: academicRank,
      alumni_category: "Faculty",
      linkedin_url: linkedinUrl,
      bio: bio,
      headline: `${academicRank} of ${department} @ VSIT`
    };
  ...
  const handleSyncComplete = (scrapedData) => {
    ...
    setFirstName(names[0] || "");
    setLastName(names.slice(1).join(" ") || "");
    setDepartment(scrapedData.stream || "");
    setAcademicRank(scrapedData.current_role || "");
  ...
  return (
    <div style={{ maxWidth: 1200, margin: "0 auto" }}>
      ...
      <p style={{ color: "#4B5563", marginBottom: 32, fontWeight: 500 }}>Update your academic rank, select department branches, and sync your LinkedIn details.</p>
        ...
        <div style={{ background: "#FFFFFF", border: "1px solid #E5E7EB", borderRadius: 20, padding: 32, boxShadow: "0 4px 12px rgba(0,0,0,0.02)" }}>
          <form onSubmit={handleSave} style={{ display: "grid", gap: 20 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, borderBottom: "1px solid #F3F4F6", paddingBottom: 12, marginTop: 12, marginBottom: 8 }}>
              ...
              <h2 style={{ fontSize: 16, fontWeight: 700, color: "#111827" }}>Academic & Instruction Credentials</h2>
            </div>

            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              <div>
                <label style={{ display: "block", fontSize: 13, color: "#4B5563", marginBottom: 6, fontWeight: 600 }}>VSIT Department Branch</label>
                <input
                  type="text"
                  value={department}
              ...
              <div>
                <label style={{ display: "block", fontSize: 13, color: "#4B5563", marginBottom: 6, fontWeight: 600 }}>Academic Rank / Role</label>
                <input
                  type="text"
                  value={academicRank}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, borderBottom: "1px solid #F3F4F6", paddingBottom: 12, marginTop: 12, marginBottom: 8 }}>
              ...
              <h2 style={{ fontSize: 16, fontWeight: 700, color: "#111827" }}>Coordinates & LinkedIn Sync</h2>
            </div>

            <div>
              <label style={{ display: "block", fontSize: 13, color: "#4B5563", marginBottom: 6, fontWeight: 600 }}>LinkedIn Profile URL</label>
              <input
                type="url"
                value={linkedinUrl}
            ...
            <div>
              <label style={{ display: "block", fontSize: 13, color: "#4B5563", marginBottom: 6, fontWeight: 600 }}>Instruction Bio</label>
              <textarea
                rows={4}
                value={bio}
                onChange={(e) => setBio(e.target.value)}
                placeholder="Give a summary of your courses taught, research papers published, and professional advising focus..."
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", borderTop: "1px solid #E5E7EB", paddingTop: 20, marginTop: 8 }}>
              ...
              <button
                type="submit"
                style={{
                  background: "linear-gradient(135deg, #0077B5, #005987)", border: "none", color: "#fff",
