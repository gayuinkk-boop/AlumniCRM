...
export default function MentorSettingsPage() {
  ...
  const handleSave = async (e) => {
    ...
    const updates = {
      ...
      bio: bio,
      headline: `${currentRole} @ ${currentCompany} | Mentor`
    };
  ...
  const handleSyncComplete = (scrapedData) => {
    ...
    setGraduationYear(scrapedData.graduation_year || "");
  ...
  return (
    <div style={{ maxWidth: 1200, margin: "0 auto" }}>
      ...
      <p style={{ color: "#4B5563", marginBottom: 32, fontWeight: 500 }}>Update your corporate advising focus, select academic parameters, and sync your LinkedIn profile.</p>
        ...
        <div style={{ background: "#FFFFFF", border: "1px solid #E5E7EB", borderRadius: 20, padding: 32, boxShadow: "0 4px 12px rgba(0,0,0,0.02)" }}>
          <form onSubmit={handleSave} style={{ display: "grid", gap: 20 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, borderBottom: "1px solid #F3F4F6", paddingBottom: 12, marginTop: 12, marginBottom: 8 }}>
              ...
              <h2 style={{ fontSize: 16, fontWeight: 700, color: "#111827" }}>Professional Advising Profile</h2>
            </div>

            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              <div>
                <label style={{ display: "block", fontSize: 13, color: "#4B5563", marginBottom: 6, fontWeight: 600 }}>Current Enterprise</label>
                <input
                  type="text"
              ...
              <div>
                <label style={{ display: "block", fontSize: 13, color: "#4B5563", marginBottom: 6, fontWeight: 600 }}>Title / Role</label>
                <input
                  type="text"
                  value={currentRole}
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 8, borderBottom: "1px solid #F3F4F6", paddingBottom: 12, marginTop: 12, marginBottom: 8 }}>
              ...
              <h2 style={{ fontSize: 16, fontWeight: 700, color: "#111827" }}>Academic & LinkedIn Coordinates</h2>
            </div>

            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              <div>
                <label style={{ display: "block", fontSize: 13, color: "#4B5563", marginBottom: 6, fontWeight: 600 }}>Graduation Year (If VSIT Alumnus)</label>
                <input
                  type="text"
              ...
              <div>
                <label style={{ display: "block", fontSize: 13, color: "#4B5563", marginBottom: 6, fontWeight: 600 }}>Preferred Mentoring Stream</label>
                <input
                  type="text"
                  value={major}
            ...
            <div>
              <label style={{ display: "block", fontSize: 13, color: "#4B5563", marginBottom: 6, fontWeight: 600 }}>Mentoring Summary</label>
              <textarea
                rows={4}
                value={bio}
                onChange={(e) => setBio(e.target.value)}
                placeholder="Give a summary of what domains you advise on and your career milestones..."
